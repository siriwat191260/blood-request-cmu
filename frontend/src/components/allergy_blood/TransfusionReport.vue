    ...
    return {
      formData: {
        ...
        BloodBagCharacteristic: {
          isTransfusionSet: null,
          needleStatus: "",
          plasmaCharacteristicStatus: "",
          isLeakagePosition: null,
          leakagePosition: "",
          volumeOfBag: null,
          TransfusionVolume: "",
        },
        indicator: [{ idIndicatorName: 0, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 1, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 2, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 3, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 4, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 5, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 6, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 7, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 8, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        { idIndicatorName: 9, PreTransfusionSample: null, PostTransfusionSample: null, bloodBagNumber: null, Remarks: null },
        ],
        GramStainAndCulture: {
          isSubmittingGramStain: null,
          gramNegativeOrPositive: "",
          resultGramStain: "",
          toDateGram: "",
          isSubmittingCulture: null,
      ...
      <div class="card" style="border: 0px; justify-content: center">
        ...
        <div class="card card-box-info-style">
          ...
          <div class="row" style="
            ...
            <div class="col-md-2">
              <input class="form-check-input" type="radio" name="needleStatus" id="needleStatus3" value="3"
                v-model="formData.BloodBagCharacteristic.needleStatus" />
              <label class="form-check-label" for="needleStatus" style=" margin-top: 2px; margin-left: 10px">ไม่มี</label>
            </div>
          </div>
          <!-- row 3 -->
          <div class="row" style="
            ...
            <div class="col-md-2 ">
              <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus" id="inlineRadio1" value="1"
                v-model="formData.BloodBagCharacteristic.plasmaCharacteristicStatus" />
              <label class="form-check-label" for="inlineRadio1" style=" margin-top: 2px; margin-left: 10px">มี
                Fibrin</label>
            </div>
            <div class="col-md-3 ">
              <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus" id="inlineRadio2" value="2"
                v-model="formData.BloodBagCharacteristic.plasmaCharacteristicStatus" />
              <label class="form-check-label" for="inlineRadio2" style=" margin-top: 2px; margin-left: 10px">ใส</label>
            </div>
            <div class="col-md-2">
              <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus" id="inlineRadio3" value="3"
                v-model="formData.BloodBagCharacteristic.plasmaCharacteristicStatus" />
          ...
          <div class="row" style="
            ...
            <div class="col-md-1" style="padding-right: 0px">
              <input class="form-check-input" type="radio" name="isLeakagePosition" id="isLeakagePosition1" value="1"
                v-model="formData.BloodBagCharacteristic.isLeakagePosition" />
            ...
            <div class="col-md-2">
              <input class="form-check-input" type="radio" name="isLeakagePosition" id="isLeakagePosition2" value="0"
                v-model="formData.BloodBagCharacteristic.isLeakagePosition" />
        ...
        <div class="card card-box-info-style">
          ...
          <div class="row" style="margin-top: 16px; ">
            ...
            <div class="col-md-9 ">
              ...
              <label class="form-check-label" for="isSubmittingGramStain2" style=" margin-top: 2px; margin-left: 10px">Not
                done</label>
            </div>
          </div>
        </div>
        <div class="card card-box-info-style">
          ...
          <div class="row" style="margin-top: 16px; ">
            ...
            <div class="col-md-3">
              <input class="form-check-input" type="radio" name="isSubmittingCulture" id="isSubmittingCulture1" value="1"
                v-model="formData.GramStainAndCulture.isSubmittingCulture" />
              <label class="form-check-label" for="isSubmittingCulture" style=" margin-top: 2px; margin-left: 10px">ส่งทำ
                Culture</label>
            </div>
            <div class="col-md-2 " v-if="parseInt(formData.GramStainAndCulture.isSubmittingCulture) === 1">
              <input class="form-check-input" type="radio" name="cultureNegativeOrPositive"
                id="cultureNegativeOrPositive1" value="0"
                v-model="formData.GramStainAndCulture.cultureNegativeOrPositive" />
              <label class="form-check-label" for="cultureNegativeOrPositive1"
                style=" margin-top: 2px; margin-left: 10px">Negative</label>
            </div>
            <div class="col-md-2 " v-if="parseInt(formData.GramStainAndCulture.isSubmittingCulture) === 1">
              <input class="form-check-input" type="radio" name="cultureNegativeOrPositive"
                id="cultureNegativeOrPositive2" value="1"
                v-model="formData.GramStainAndCulture.cultureNegativeOrPositive" />
          ...
          <div class="row" style="margin-top: 16px; justify-content: flex-end"
            ...
            <div class="col-md-3 ">
              <input class="form-check-input" type="radio" name="cultureNegativeOrPositive"
                id="cultureNegativeOrPositive3" value="2"
                v-model="formData.GramStainAndCulture.cultureNegativeOrPositive" />
          ...
          <div class="row" style="margin-top: 16px; ">
            ...
            <div class="col-md-9 ">
              <input class="form-check-input" type="radio" name="isSubmittingCulture" id="isSubmittingCulture2" value="0"
                v-model="formData.GramStainAndCulture.isSubmittingCulture" />
              <label class="form-check-label" for="isSubmittingCulture2" style=" margin-top: 2px; margin-left: 10px">Not
                done</label>
            </div>
          </div>
        </div>
              ...
              <div class="card-box-info-row-component-style">
                <div style="display: inline; position: absolute; width: 100%">
                  ...
                  <ul v-if="showResultsReport && formData.data.reportedBy.length >= 1
                    " class="autocomplete-results">
                    <li v-for="(item, index) in filteredItems()" :key="index" @click="selectReport(item)">
                      {{ item }}
                    </li>
                  </ul>
                </div>
                  ...
                  <div style="position: relative">
                    <div style="display: inline; position: absolute; width: 100%">
                      <input class="form-control typing-box-style" style="
                        ...
                        :disabled="formData.data.reportedBy.length === 0" aria-label="readonly input example"
                        id="reportedDate" name="reportedDate" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div style="position: relative">
                    <div style="display: inline; position: absolute; width: 100%">
                      <input class="form-control typing-box-style" style="
                        ...
                        :disabled="formData.data.reportedBy.length === 0" aria-label="readonly input example"
                        id="reportedTime" name="reportedTime" />
                    </div>
                  </div>
                </div>
              </div>
