          ...
          <div class="row" style="
            ...
            <div class="col-md-3 form-check-inline">
              <input class="form-check-input" type="radio" name="isTransfusionSet" id="isTransfusionSet2" value="0"
                v-model="formData.BloodBagCharacteristic.isTransfusionSet" />
              <label class="form-check-label" for="isTransfusionSet"
          ...
          <div class="row" style="
            ...
            <div class="col-md-2 ">
              <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus"
                id="plasmaCharacteristicStatus" value="1"
                v-model="formData.BloodBagCharacteristic.plasmaCharacteristicStatus" />
              <label class="form-check-label" for="plasmaCharacteristicStatus1"
                style=" margin-top: 2px; margin-left: 10px">มี Fibrin</label>
            </div>
            <div class="col-md-3 ">
              <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus"
                id="plasmaCharacteristicStatus2" value="2"
                v-model="formData.BloodBagCharacteristic.plasmaCharacteristicStatus" />
            ...
            <div class="col-md-2">
              <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus"
                id="plasmaCharacteristicStatus3" value="3"
                v-model="formData.BloodBagCharacteristic.plasmaCharacteristicStatus" />
        ...
        <div class="card card-box-info-style">
          ...
          <div class="row" style="margin-top: 16px; ">
            ...
            <div class="col-md-3">
              ...
              <label class="form-check-label" for="isSubmittingCulture1" style=" margin-top: 2px; margin-left: 10px">ส่งทำ
                Culture</label>
            </div>
