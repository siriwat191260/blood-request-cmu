...
export default defineComponent({
  ...
  data() {
    return {
      formData: {
        ...
        TransfusionMedicalDirectorReview: {
          reaction: "",
          caseDefinitionCriteria: "",
          severity: "",
          imputability: "",
          approvedBy: "",
          approvedTime: "",
  ...
  methods: {
    ...
    importData() {
      ...
      this.formData.TransfusionMedicalDirectorReview.severity = this.tr_report.data.severity
      this.formData.TransfusionMedicalDirectorReview.imputability = this.tr_report.data.imputability
      ...
      <div class="card" style="border: 0px; justify-content: center">
        ...
        <div>
              ...
              <div class="card card-box-style">
                <div class="card-body card-box-body-style">
                  ...
                  <p class="fontInsideBox">
                    <Icon icon="bx:id-card" style="color: #00bfa5; width: 32; height: 32; margin-bottom: 4px;"></Icon>
                    &nbsp; {{ formData.data.HN }}
                  </p>
                </div>
              </div>
          ...
          <div class="card card-box-info-style">
            ...
            <div class="row" style="
              ...
              <div class="col-md-2 ">
                <input :disabled="formData.BloodBagCharacteristic.isTransfusionSet !== 1" class="form-check-input"
                  type="radio" name="isTransfusionSet" id="isTransfusionSet1"
              ...
              <div class="col-md-3 form-check-inline">
                <input :disabled="formData.BloodBagCharacteristic.isTransfusionSet !== 0" class="form-check-input"
                  type="radio" name="isTransfusionSet" id="isTransfusionSet2"
                  :checked="parseInt(formData.BloodBagCharacteristic.isTransfusionSet) === 0" />
            ...
            <div class="row" style="
              ...
              <div class="col-md-2 ">
                ...
                <label class="form-check-label" for="needleStatus1" style=" margin-top: 2px; margin-left: 10px">มี
                  ปิดสนิท</label>
              </div>
              <div class="col-md-3 ">
                ...
                <label class="form-check-label" for="needleStatus2" style=" margin-top: 2px; margin-left: 10px">มี
                  ปิดไม่สนิท</label>
              </div>
              <div class="col-md-2">
                ...
                <label class="form-check-label" for="needleStatus3"
                  style=" margin-top: 2px; margin-left: 10px">ไม่มี</label>
              </div>
            </div>
            <!-- row 3 -->
            <div class="row" style="
              ...
              <div class="col-md-2 ">
                <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus"
                  id="plasmaCharacteristicStatus1"
                  :disabled="formData.BloodBagCharacteristic.plasmaCharacteristicStatus != 1"
                  :checked="formData.BloodBagCharacteristic.plasmaCharacteristicStatus === 1" />
                <label class="form-check-label" for="plasmaCharacteristicStatus2"
                  style=" margin-top: 2px; margin-left: 10px">มี Fibrin</label>
              </div>
              <div class="col-md-3 ">
                <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus"
                  id="plasmaCharacteristicStatus2"
                  :disabled="formData.BloodBagCharacteristic.plasmaCharacteristicStatus != 2"
              ...
              <div class="col-md-2">
                <input class="form-check-input" type="radio" name="plasmaCharacteristicStatus"
                  id="plasmaCharacteristicStatus3"
                  :disabled="formData.BloodBagCharacteristic.plasmaCharacteristicStatus != 3"
                  :checked="formData.BloodBagCharacteristic.plasmaCharacteristicStatus === 3" />
                <label class="form-check-label" for="plasmaCharacteristicStatus3"
            ...
            <div class="row" style="
              ...
              <div class="col-md-1" style="padding-right: 0px">
                ...
                <label class="form-check-label" for="isLeakagePosition1" style=" margin-top: 2px; margin-left: 10px">มี
                </label>
              </div>
              <div class="col-md-4">
                <div class="card-box-info-row-component-style"
          ...
          <div class="card card-box-info-style">
            ...
            <div class="row" style="margin-top: 16px; ">
              ...
              <div class="col-md-3">
                <input class="form-check-input" type="radio" name="isSubmittingGramStain" id="isSubmittingGramStain1"
                  :disabled="formData.GramStainAndCulture.isSubmittingGramStain != 1"
              ...
              <div class="col-md-2 " v-if="parseInt(formData.GramStainAndCulture.isSubmittingGramStain) === 1">
                ...
                <label class="form-check-label" style=" margin-top: 2px; margin-left: 10px">Negative</label>
              </div>
              <div class="col-md-2 " v-if="parseInt(formData.GramStainAndCulture.gramNegativeOrPositive) === 1">
                ...
                <label class="form-check-label" style=" margin-top: 2px; margin-left: 10px">Positive</label>
              </div>
            ...
            <div class="row" style="margin-top: 16px; justify-content: flex-end"
              ...
              <div class="col-md-3 ">
                ...
                <label class="form-check-label" style=" margin-top: 2px; margin-left: 10px">รอผลออกวันที่</label>
              </div>
              <div class="col-md-4">
                <div class="card-box-info-row-component-style"
                  v-if="parseInt(formData.GramStainAndCulture.gramNegativeOrPositive) === 2">
            ...
            <!-- row 3 -->
            <div class="row" style="margin-top: 16px; "
              v-if="parseInt(formData.GramStainAndCulture.isSubmittingGramStain) === 0">
              <p class=" col-md-2">
              </p>
              <div class="col-md-9 ">
                <input class="form-check-input" type="radio" name="isSubmittingGramStain"
                  :disabled="formData.GramStainAndCulture.isSubmittingGramStain != 0"
                  :checked="formData.GramStainAndCulture.isSubmittingGramStain === 0" />
                <label class="form-check-label" style=" margin-top: 2px; margin-left: 10px">Not done</label>
              </div>
            </div>
          </div>
          <div class="card card-box-info-style">
            ...
            <div class="row" style="margin-top: 16px; ">
              ...
              <div class="col-md-3">
                ...
                <label class="form-check-label" style=" margin-top: 2px; margin-left: 10px">ส่งทำ
                  Culture</label>
              </div>
            ...
            <!-- row 3 -->
            <div class="row" style="margin-top: 16px; "
              v-if="parseInt(formData.GramStainAndCulture.isSubmittingCulture) === 0">
              <p class=" col-md-2">
              </p>
              <div class="col-md-9 ">
                <input class="form-check-input" type="radio" name="isSubmittingCulture"
        ...
        <div class="card card-box-info-style">
          ...
          <div class="row" style="
                        margin-top: 16px;
                        ">
            <p class="name fontTopicCheckBox">
              Reaction
            </p>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="reaction" id="reaction1"
                :value="formData.TransfusionMedicalDirectorReview.reaction"
                :disabled="formData.TransfusionMedicalDirectorReview.reaction != 1"
                :checked="formData.TransfusionMedicalDirectorReview.reaction == 1" />
              <label class="form-check-label" for="reaction1"
                style="margin-top: 2px; margin-left: 10px">Allergic/Anaphylatic</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="reaction" id="reaction2"
                :value="formData.TransfusionMedicalDirectorReview.reaction"
                :disabled="formData.TransfusionMedicalDirectorReview.reaction != 2"
                :checked="formData.TransfusionMedicalDirectorReview.reaction == 2" />
              <label class="form-check-label" for="reaction2" style="margin-top: 2px; margin-left: 10px ">TRALI</label>
            </div>
            <div class="row1"></div>
            <div class="row1"></div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="reaction" id="reaction3"
                :value="formData.TransfusionMedicalDirectorReview.reaction"
                :disabled="formData.TransfusionMedicalDirectorReview.reaction != 3"
                :checked="formData.TransfusionMedicalDirectorReview.reaction == 3" />
              <label class="form-check-label" for="reaction3" style="margin-top: 2px; margin-left: 10px">Septic
                Transfusion Reaction</label>
            </div>
            <div class="row1o"></div>
            <div class="row1o"></div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="reaction" id="reaction4"
                :value="formData.TransfusionMedicalDirectorReview.reaction"
                :disabled="formData.TransfusionMedicalDirectorReview.reaction != 4"
                :checked="formData.TransfusionMedicalDirectorReview.reaction == 4" />
              <label class="form-check-label" for="reaction4" style="margin-top: 2px; margin-left: 10px">Other</label>
            </div>
            <div class="col-md-3">
              <div class="card-box-info-row-component-style" style="height: 30px;"
                v-if="parseInt(formData.TransfusionMedicalDirectorReview.reaction) === 4">
                <div style="display: inline; position: absolute; width: 100%; ">
                  <input class="form-control typing-box-style" style="
                                        padding-top: 5px;
                                        padding-bottom: 0px;
                                        " aria-label="default input example" placeholder="กรุณากรอกข้อมูล"
                    :value="formData.TransfusionMedicalDirectorReview.other" readonly />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row" style="
            ...
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="caseDefinitionCriteria1"
                :value="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria"
                :disabled="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria != 1"
                :checked="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria == 1" />
              <label class="form-check-label" for="caseDefinitionCriteria1"
                style="margin-top: 2px; margin-left: 10px">Definitive</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="caseDefinitionCriteria2"
                :value="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria"
                :disabled="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria != 2"
                :checked="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria == 2" />
              <label class="form-check-label" for="caseDefinitionCriteria2"
                style="margin-top: 2px; margin-left: 10px ">Probable</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="caseDefinitionCriteria3"
                :value="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria"
                :disabled="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria != 3"
                :checked="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria == 3" />
              <label class="form-check-label" for="caseDefinitionCriteria3"
                style="margin-top: 2px; margin-left: 10px">Possible</label>
            </div>
          </div>
          <!-- row 3 -->
          <div class="row" style="
            ...
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="severity" id="severity1"
                :value="formData.TransfusionMedicalDirectorReview.severity"
                :disabled="formData.TransfusionMedicalDirectorReview.severity != 1"
                :checked="formData.TransfusionMedicalDirectorReview.severity == 1" />
              <label class="form-check-label" for="severity1"
                style="margin-top: 2px; margin-left: 10px">Non-severe</label>
            </div>
            <div class="" style="width: auto">
              <input class="form-check-input" type="radio" name="severity" id="severity2"
                :value="formData.TransfusionMedicalDirectorReview.severity"
                :disabled="formData.TransfusionMedicalDirectorReview.severity != 2"
                :checked="formData.TransfusionMedicalDirectorReview.severity == 2" />
              <label class="form-check-label" for="severity2" style="margin-top: 2px; margin-left: 10px ">Severe</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="severity" id="severity3"
                :value="formData.TransfusionMedicalDirectorReview.severity"
                :disabled="formData.TransfusionMedicalDirectorReview.severity != 3"
                :checked="formData.TransfusionMedicalDirectorReview.severity == 3" />
              <label class="form-check-label" for="severity3" style="margin-top: 2px; margin-left: 10px">Life
                Threatening</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="severity" id="severity4"
                :value="formData.TransfusionMedicalDirectorReview.severity"
                :disabled="formData.TransfusionMedicalDirectorReview.severity != 4"
                :checked="formData.TransfusionMedicalDirectorReview.severity == 4" />
              <label class="form-check-label" for="severity4" style="margin-top: 2px; margin-left: 10px">Death</label>
            </div>
          </div>
          <!-- row 4 -->
          <div class="row" style="
            ...
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="imputability1"
                :value="formData.TransfusionMedicalDirectorReview.imputability"
                :disabled="formData.TransfusionMedicalDirectorReview.imputability != 1"
                :checked="formData.TransfusionMedicalDirectorReview.imputability == 1" />
              <label class="form-check-label" for="imputability1"
                style="margin-top: 2px; margin-left: 10px">Definitive</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="imputability2"
                :value="formData.TransfusionMedicalDirectorReview.imputability"
                :disabled="formData.TransfusionMedicalDirectorReview.imputability != 2"
                :checked="formData.TransfusionMedicalDirectorReview.imputability == 2" />
              <label class="form-check-label" for="imputability2"
                style="margin-top: 2px; margin-left: 10px ">Probable</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="imputability3"
                :value="formData.TransfusionMedicalDirectorReview.imputability"
                :disabled="formData.TransfusionMedicalDirectorReview.imputability != 3"
                :checked="formData.TransfusionMedicalDirectorReview.imputability == 3" />
              <label class="form-check-label" for="imputability3"
                style="margin-top: 2px; margin-left: 10px">Possible</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="imputability4"
                :value="formData.TransfusionMedicalDirectorReview.imputability"
                :disabled="formData.TransfusionMedicalDirectorReview.imputability != 4"
                :checked="formData.TransfusionMedicalDirectorReview.imputability == 4" />
              <label class="form-check-label" for="imputability4"
                style="margin-top: 2px; margin-left: 10px">Doubtful</label>
            </div>
            <div class="row1"></div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="imputability5"
                :value="formData.TransfusionMedicalDirectorReview.imputability"
                :disabled="formData.TransfusionMedicalDirectorReview.imputability != 5"
                :checked="formData.TransfusionMedicalDirectorReview.imputability == 5" />
              <label class="form-check-label" for="imputability5" style="margin-top: 2px; margin-left: 10px">Ruled
                out</label>
            </div>
            <div class="row1o"></div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="imputability6"
                :value="formData.TransfusionMedicalDirectorReview.imputability"
                :disabled="formData.TransfusionMedicalDirectorReview.imputability != 6"
                :checked="formData.TransfusionMedicalDirectorReview.imputability == 6" />
              <label class="form-check-label" for="imputability6" style="margin-top: 2px; margin-left: 10px">Not
                Determined</label>
            </div>
          </div>
        </div>
            ...
            <div class="card-box-info-row-component-style">
              <div style="display: inline; position: absolute; width: 100%">
                ...
                <input disabled class="form-control typing-box-style" style="
                  ...
                  :value="formData.TransfusionMedicalDirectorReview.approvedBy" readonly />
              </div>
            </div>
          </div>
          <div class="col-md-3">
