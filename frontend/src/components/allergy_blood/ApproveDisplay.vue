                ...
                <div>
                    ...
                    <div class="card card-box-info-style">
                        ...
                        ">
                            ...
                            <div class="col-md-2 ">
                                ...
                                <label class="form-check-label" for="inlineRadio1"
                                    style=" margin-top: 2px; margin-left: 10px">มี
                                    ปิดสนิท</label>
                            </div>
                            <div class="col-md-3 ">
                    ...
                    <div class="card card-box-info-style">
                        ...
                        <div class="row" style="margin-top: 16px; ">
                            ...
                            <div class="col-md-2 "
                                v-if="parseInt(formData.GramStainAndCulture.gramNegativeOrPositive) === 1">
                                <input class="form-check-input" type="radio" name="gramNegativeOrPositive"
                    ...
                    <div class="card card-box-info-style">
                        ...
                        <div class="row" style="margin-top: 16px; ">
                            ...
                            <div class="col-md-3">
                                ...
                                <label class="form-check-label" for="inlineRadio1"
                                    style=" margin-top: 2px; margin-left: 10px">ส่งทำ
                                    Culture</label>
                            </div>
                            ...
                            <div class="col-md-3"
                                v-if="parseInt(formData.GramStainAndCulture.cultureNegativeOrPositive) === 1">
                                <div class="card-box-info-row-component-style">
                                    <div style="display: inline; position: absolute; width: 100%">
                                        <p class="fontTopicInfo" style="margin-left: 16px;">
                                            ผล
                ...
                <div class="card card-box-info-style">
                    ...
                    <div class="row" style="
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="reaction" id="inlineRadio1"
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="reaction" id="inlineRadio2"
                                :value="formData.TransfusionMedicalDirectorReview.reaction"
                            ...
                            <label class="form-check-label" for="inlineRadio2"
                                style="margin-top: 2px; margin-left: 10px ">TRALI</label>
                        </div>
                        <div class="row1"></div>
                        <div class="row1"></div>
                        <div style="width: auto">
                            ...
                            <label class="form-check-label" for="inlineRadio2"
                                style="margin-top: 2px; margin-left: 10px">Septic Transfusion Reaction</label>
                        </div>
                        <div class="row1o"></div>
                        <div class="row1o"></div>
                        <div style="width: auto">
                            ...
                            <label class="form-check-label" for="inlineRadio2"
                                style="margin-top: 2px; margin-left: 10px">Other</label>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row" style="
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="inlineRadio1"
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="inlineRadio2"
                                :value="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria"
                    ...
                    <div class="row" style="
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="severity" id="inlineRadio1"
                        ...
                        <div class="" style="width: auto">
                            <input class="form-check-input" type="radio" name="severity" id="inlineRadio2"
                                :value="formData.TransfusionMedicalDirectorReview.severity"
                        ...
                        <div style="width: auto">
                            ...
                            <label class="form-check-label" for="inlineRadio2"
                                style="margin-top: 2px; margin-left: 10px">Life Threatening</label>
                        </div>
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="severity" id="inlineRadio2"
                                :value="formData.TransfusionMedicalDirectorReview.severity"
                            ...
                            <label class="form-check-label" for="inlineRadio2"
                                style="margin-top: 2px; margin-left: 10px">Death</label>
                        </div>
                    </div>
                    <!-- row 4 -->
                    <div class="row" style="
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="imputability" id="inlineRadio1"
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="imputability" id="inlineRadio2"
                                :value="formData.TransfusionMedicalDirectorReview.imputability"
                        ...
                        <div style="width: auto">
                            ...
                            <label class="form-check-label" for="inlineRadio2"
                                style="margin-top: 2px; margin-left: 10px">Ruled out</label>
                        </div>
                        <div class="row1o"></div>
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="imputability" id="inlineRadio2"
                            ...
                            <label class="form-check-label" for="inlineRadio2"
                                style="margin-top: 2px; margin-left: 10px">Not Determined</label>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top: 16px;">
                                ...
                                <div style="position: relative">
                                    <div style="display: inline; position: absolute; width: 100%">
                                        <input class="form-control typing-box-style" style="
                                                ...
                                                padding-bottom: 0px;
                                                " type="date"
                                            :value="formData.TransfusionMedicalDirectorReview.approvedDate"
                                ...
                                <div style="position: relative">
                                    <div style="display: inline; position: absolute; width: 100%">
                                        <input class="form-control typing-box-style" style="
                                                ...
                                                padding-bottom: 0px;
                                                " type="time"
                                            :value="formData.TransfusionMedicalDirectorReview.approvedTime"
                                            aria-label="readonly input example" id="birthdaytime" name="birthdaytime" />
                                    </div>
                                </div>
                            </div>
