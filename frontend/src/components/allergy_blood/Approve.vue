...
export default defineComponent({
  ...
  methods: {
    ...
    importData() {
      ...
      this.formData.TransfusionMedicalDirectorReview.approvedBy = this.userInfo.name
    ...
    async handleSubmit(formData) {
      try {
        const { TransfusionMedicalDirectorReview } = formData;
        const approvedDateTime = TransfusionMedicalDirectorReview.approvedDate ? new Date(`${TransfusionMedicalDirectorReview.approvedDate} ${TransfusionMedicalDirectorReview.approvedTime}`) : null;

        const cleasingFormData = {
          reaction: TransfusionMedicalDirectorReview.reaction,
          caseDefinitionCriteria: TransfusionMedicalDirectorReview.caseDefinitionCriteria,
          severity: TransfusionMedicalDirectorReview.severity,
          imputability: TransfusionMedicalDirectorReview.imputability,
          approvedBy: TransfusionMedicalDirectorReview && TransfusionMedicalDirectorReview.approvedBy ? TransfusionMedicalDirectorReview.approvedBy : null,
          approvedDateTime: TransfusionMedicalDirectorReview && approvedDateTime ? approvedDateTime : null,
          idTR_Report: this.$route.params.id,
          other: TransfusionMedicalDirectorReview.other
        }
        console.log("Form submitted! : ", formData);
        console.log("cleasingFormData submitted! : ", cleasingFormData);
        const response = await axios.put(
          this.baseURL + `submitting_approve`,
  ...
  watch: {
    ...
    'formData.TransfusionMedicalDirectorReview.other': function (oldVal) {
      if (oldVal == 4) {
        this.formData.TransfusionMedicalDirectorReview.other = "";
      }
    },
  },
  computed: {
        ...
        <div class="card card-box-info-style">
          ...
          <div class="row" style="
            ...
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="reaction" id="inlineRadio1" value="1"
                v-model="formData.TransfusionMedicalDirectorReview.reaction" />
              <label class="form-check-label" for="inlineRadio1"
                style="margin-top: 2px; margin-left: 10px">Allergic/Anaphylatic</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="reaction" id="inlineRadio2" value="2"
                v-model="formData.TransfusionMedicalDirectorReview.reaction" />
              <label class="form-check-label" for="inlineRadio2" style="margin-top: 2px; margin-left: 10px ">TRALI</label>
            </div>
            <div class="row1"></div>
            <div class="row1"></div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="reaction" id="inlineRadio2" value="3"
                v-model="formData.TransfusionMedicalDirectorReview.reaction" />
              <label class="form-check-label" for="inlineRadio2" style="margin-top: 2px; margin-left: 10px">Septic
                Transfusion Reaction</label>
            </div>
            <div class="row1o"></div>
            <div class="row1o"></div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="reaction" id="inlineRadio2" value="4"
                v-model="formData.TransfusionMedicalDirectorReview.reaction" />
              <label class="form-check-label" for="inlineRadio2" style="margin-top: 2px; margin-left: 10px">Other</label>
            </div>
            <div class="col-md-3">
              <div class="card-box-info-row-component-style" style="height: 30px;"
                ...
                <div style="display: inline; position: absolute; width: 100%; ">
                  <input class="form-control typing-box-style" style="
                    ...
                    v-model="formData.TransfusionMedicalDirectorReview.other" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row" style="
            ...
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="inlineRadio1" value="1"
                v-model="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria" />
              <label class="form-check-label" for="inlineRadio1"
                style="margin-top: 2px; margin-left: 10px">Definitive</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="inlineRadio2" value="2"
                v-model="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria" />
              <label class="form-check-label" for="inlineRadio2"
                style="margin-top: 2px; margin-left: 10px ">Probable</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="inlineRadio2" value="3"
                v-model="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria" />
              <label class="form-check-label" for="inlineRadio2"
          ...
          <div class="row" style="
            ...
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="severity" id="inlineRadio1" value="1"
                v-model="formData.TransfusionMedicalDirectorReview.severity" />
              <label class="form-check-label" for="inlineRadio1"
                style="margin-top: 2px; margin-left: 10px">Non-severe</label>
            </div>
            <div class="" style="width: auto">
              <input class="form-check-input" type="radio" name="severity" id="inlineRadio2" value="2"
                v-model="formData.TransfusionMedicalDirectorReview.severity" />
              <label class="form-check-label" for="inlineRadio2"
                style="margin-top: 2px; margin-left: 10px ">Severe</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="severity" id="inlineRadio2" value="3"
                v-model="formData.TransfusionMedicalDirectorReview.severity" />
              <label class="form-check-label" for="inlineRadio2" style="margin-top: 2px; margin-left: 10px">Life
                Threatening</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="severity" id="inlineRadio2" value="4"
                v-model="formData.TransfusionMedicalDirectorReview.severity" />
              <label class="form-check-label" for="inlineRadio2" style="margin-top: 2px; margin-left: 10px">Death</label>
            </div>
          </div>
          <!-- row 4 -->
          <div class="row" style="
            ...
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="inlineRadio1" value="1"
                v-model="formData.TransfusionMedicalDirectorReview.imputability" />
              <label class="form-check-label" for="inlineRadio1"
                style="margin-top: 2px; margin-left: 10px">Definitive</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="inlineRadio2" value="2"
                v-model="formData.TransfusionMedicalDirectorReview.imputability" />
              <label class="form-check-label" for="inlineRadio2"
                style="margin-top: 2px; margin-left: 10px ">Probable</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="inlineRadio2" value="3"
                v-model="formData.TransfusionMedicalDirectorReview.imputability" />
              <label class="form-check-label" for="inlineRadio2"
                style="margin-top: 2px; margin-left: 10px">Possible</label>
            </div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="inlineRadio2" value="4"
                v-model="formData.TransfusionMedicalDirectorReview.imputability" />
              <label class="form-check-label" for="inlineRadio2"
            ...
            <div class="row1"></div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="inlineRadio2" value="5"
                v-model="formData.TransfusionMedicalDirectorReview.imputability" />
              <label class="form-check-label" for="inlineRadio2" style="margin-top: 2px; margin-left: 10px">Ruled
                out</label>
            </div>
            <div class="row1o"></div>
            <div style="width: auto">
              <input class="form-check-input" type="radio" name="imputability" id="inlineRadio2" value="6"
                v-model="formData.TransfusionMedicalDirectorReview.imputability" />
              <label class="form-check-label" for="inlineRadio2" style="margin-top: 2px; margin-left: 10px">Not
                Determined</label>
            </div>
          </div>
        </div>
                ...
                <div style="position: relative">
                  <div style="display: inline; position: absolute; width: 100%">
                    <input class="form-control typing-box-style" style="
                                            ...
                                            padding-bottom: 0px;
                                            " type="date"
                      v-model="formData.TransfusionMedicalDirectorReview.approvedDate" aria-label="readonly input example"
        ...
        <div class="modal fade" id="SaveButton" tabindex="-1" aria-labelledby="saveModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" @click="navigateToPreviousPage">
                  ปิด
                </button>
              </div>
            </div>
