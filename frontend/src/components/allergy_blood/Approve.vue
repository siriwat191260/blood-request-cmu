                    ...
                    <div class="row" style="
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="inlineRadio1"
                                value="1" v-model="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria" />
                            <label class="form-check-label" for="inlineRadio1"
                        ...
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="inlineRadio2"
                                value="2" v-model="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria" />
                            <label class="form-check-label" for="inlineRadio2"
                                style="margin-top: 2px; margin-left: 10px ">Probable</label>
                        </div>
                        <div style="width: auto">
                            <input class="form-check-input" type="radio" name="caseDefinitionCriteria" id="inlineRadio2"
                                value="3" v-model="formData.TransfusionMedicalDirectorReview.caseDefinitionCriteria" />
                            <label class="form-check-label" for="inlineRadio2"
                                ...
                                <div style="position: relative">
                                    <div style="display: inline; position: absolute; width: 100%">
                                        <input class="form-control typing-box-style" style="
                                            ...
                                            padding-top: 0px;
                                            padding-bottom: 0px;
                                            " type="date" v-model="formData.TransfusionMedicalDirectorReview.approvedDate"
